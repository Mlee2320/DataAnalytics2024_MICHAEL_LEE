...
nyc <- read.csv("C:/Users/leem21/STM32CubeIDE/DataAnalytics2024_MICHAEL_LEE/Data\ Analytics/Assignments/Assignment\ 4/NYC_Citywide_Annualized_Calendar_Sales_Update_20240402.csv")
View(nyc)
